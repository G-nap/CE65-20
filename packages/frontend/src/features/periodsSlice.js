...
const CREATE_URL = `https://${URL}/period/post/`
const FETCH_URL = `https://${URL}/period/periods`
const UPDATE_URL = `https://${URL}/period/edit?periodID=`
const DELETE_URL = `https://${URL}/period/delete?periodID=`
